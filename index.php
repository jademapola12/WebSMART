        ...
        <div class="content-wrapper pt-5">
            ...
            <div id="header" class="shadow mb-4">
                <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column text-center px-3">
                    <h1 class="text-white fw-bold" style="text-shadow: 5px 5px 5px black; font-size: 100px;"><?php echo $_settings->info('name') ?></h1>
                    <script>
...
<div class="row w-50 mt-5 g-2">
    ...
    <?php else: ?>
                <a href="?page=about" 
        class="navbtn btn btn-transparent text-light font-weight-bold text-center d-block mx-auto" 
        data-bs-toggle="tooltip" 
        title="Find out more about us and what we do" 
        style="width: fit-content; display: block; text-align: center; margin: auto;">
            <img src="uploads/question-mark.png" alt="" style="width: 120px; max-width: 100%;"><br>ABOUT&nbsp;US
        </a>
    <?php endif; ?>
</div>
<script>
